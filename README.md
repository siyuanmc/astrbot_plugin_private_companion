...
- 模型与成本编排：为日程、细化、梦境、日记、创作、回复自检、关系分析、记忆整理、生图提示词等任务分别指定 Provider。
- 扩展页管理：在 AstrBot WebUI 中查看私聊、群聊、关系网、状态、梦境、创作、额度、主动计划、Token 消耗和模块配置。
...
- 配置分项模型 Provider，例如日程生成、日程细化、日记、梦境、私下创作、主动语音文案、昨日对话摘要、回复自检、关系分析、记忆整理、群聊黑话释义和生图提示词模型。
